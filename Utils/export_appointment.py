...
def generate_appointment_pdf(patient_info,  prescription_info, diagnosis_info, lab_info):
  ...
  appointment_data = [
    ["Lab Analysis", Paragraph(lab_info['lab_details'], styles['Normal'])],
    ["Diagnosed with", Paragraph(diagnosis_info['diagnosis_details'], styles['Normal'])],
    ["Diagnosis Note", Paragraph(diagnosis_info['note'], styles['Normal'])],
    ["Prescribed Medication", Paragraph(prescription_info['prescription_details'], styles['Normal'])],
    ["Doctor's Note", Paragraph(prescription_info['note'], styles['Normal'])]
]
